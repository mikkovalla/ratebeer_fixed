class UsersController < ApplicationController
    ...
    def show
        ...
        @unconfirmed_memberships = Membership.unconfirmed.where(user_id: @user.id)
    end
    ...
    def toggle_ban
        ...
        status = user.banned ? 'frozen' : 'active'

        redirect_to :back, notice: "User's account is now #{status}"
    end
